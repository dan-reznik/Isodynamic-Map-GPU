...
So in the above, the (red) equilateral is sent to the green triangle, which is sent to the blue triangle, and then back to the red equilateral, forever if the map continued on! If M is allow to slide within an identity zone, both green an blue triangles change, but a third application of the map will invariably go back to the original.
...
Let your browser compute it [live](https://dan-reznik.github.io/Isodynamic-Map-GPU/)!
